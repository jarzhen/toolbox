...
public class ASMTest {
    ...
    public static void redefineHelloWorldClass() {
        try {
            InputStream inputStream = new FileInputStream("/git_project/toolbox/target/test-classes/cn/tool/code/asm/HelloWorld.class");
            ...
            try {
                // 将二进制流写到本地磁盘上
                FileOutputStream fos = new FileOutputStream("/git_project/toolbox/target/test-classes/cn/tool/code/asm/HelloWorld.class");
                fos.write(code);
                fos.close();
            } catch (IOException e) {
                e.printStackTrace();
